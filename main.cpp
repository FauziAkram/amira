...
constexpr PhaseScore passed_pawn_bonus[8] = {
    {0, 0}, {5, 12}, {15, 28}, {25, 42}, {40, 66}, {58, 96}, {79, 121}, {0, 0}
};
...
constexpr PhaseScore BISHOP_OUTPOST_BONUS          = {25, 17};
constexpr PhaseScore POTENTIAL_DOMINANCE_BONUS     = {6, 4};
constexpr PhaseScore ROOK_ON_OPEN_FILE             = {29, 12};
constexpr PhaseScore ROOK_ON_SEMI_OPEN_FILE        = {11, 7};
constexpr PhaseScore RookOnEnemyTerritoryBonus     = {20, 27};
constexpr PhaseScore ConnectedRooksOnTerritoryBonus  = {5, 7};
...
constexpr PhaseScore PasserBlockedBonus[2][8] = {
    ...
    {{0, 0}, {-5, -6}, {-24, -2}, {-3, -6}, {2, -11}, {-8, -57}, {56, -40}, {0, 0}}
};
constexpr PhaseScore PasserUnsafeBonus[2][8] = {
    {{0, 0}, {10, 5}, {5, 14}, {-5, 17}, {-12, 33}, {46, 50}, {110, 22}, {0, 0}},
    {{0, 0}, {3, 3}, {2, 10}, {-1, 0}, {6, -6}, {59, -35}, {74, -54}, {0, 0}}
};
constexpr PhaseScore THREAT_BY_MINOR[7] = {
    {0,0}, {1,9}, {16,12}, {20,14}, {25,32}, {20,39}, {0,0} // Pawn, Knight, Bishop, Rook, Queen, King
};
