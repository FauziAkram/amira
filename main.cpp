...
int evaluate(Position& pos) {
    ...
    for (int c_idx = 0; c_idx < 2; ++c_idx) {
        ...
        if (king_sq != -1) {
             ...
             king_areas[c] = king_attacks_bb[king_sq]; // Simple king area for now
        }
    ...
    for (int c_idx = 0; c_idx < 2; ++c_idx) {
        ...
        if (king_sq != -1) {
            ...
            if (king_attackers_count[current_eval_color] > 1) {
                ...
                current_color_score.mg -= safety_score * safety_score / 720;
                current_color_score.eg -= safety_score / 20;
            }
        } // end king safety
